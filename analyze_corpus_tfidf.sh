...
python tools/analysis/tfidf_compare.py \
    ...
    --output_image analysis/tfidf-analysis-beir.png \
    --output_text analysis/tfidf-analysis-beir.txt \
...
python tools/analysis/tfidf_compare.py \
    ...
    --output_image analysis/tfidf-analysis-lotte.png  \
    --output_text analysis/tfidf-analysis-lotte.txt \
    --min_df 0.01 --max_ngram 1
...
#     --files_path ${dataset_dir}/beir/scidocs/collection/corpus.jsonl \
#     --files_path ${dataset_dir}/beir/trec-covid/collection/corpus.jsonl \
#     --output_image analysis/test-2gram-analysis-beir.png \
#     --output_text analysis/test-2gram-analysis-beir.txt \
