...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--output_dir", type=str, default="./", help="models are saved here"
        )
        # [modify] use the train_data_dir instead. this can be multidataset in contriever
        # self.parser.add_argument(
        #     "--train_data",
        #     nargs="+",
        ...
        # )
        self.parser.add_argument(
            "--train_data_dir", default='/home/dju/datasets/test_collection/bert-base-uncased',
        )
        self.parser.add_argument(
            "--eval_data",
            nargs="+",
